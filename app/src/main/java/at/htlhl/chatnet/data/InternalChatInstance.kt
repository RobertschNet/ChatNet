...
data class InternalChatInstance(
    val personList: FirebaseUser, // instance of the person the chat is with (FirebaseUsers)
    val timestampMessage: Timestamp, // timestamp of the last message sent in the chat (FirebaseMessages timestamp)
    val lastMessage: InternalMessageInstance,  // last message sent in the chat (FirebaseMessages)
