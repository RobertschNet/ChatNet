...
data class FirebaseChats(
    val members: List<String>, // list of the members of the chat (FirebaseUsers ids)
    val pinned: List<String>, // list of the users that have pinned the chat (FirebaseUsers ids)
    ...
    var messages: List<FirebaseMessages>, // list of all messages sent in the chat (FirebaseMessages)
) {
    constructor() : this(
        arrayListOf(),
        arrayListOf(),
